...
export default class User {
        ...
        try {
            ...
            if (newType == "Swim" || newType == "Bike" || newType == "Run") {
                ...
                for (let i = 0; i < this.allMyGoals.length; i++) {
                    ...
                    this.allMyGoals[i].checkForGoalCompletion()
                }
    ...
    sortByDate(type) {
        ...
        return baseArray.sort(function(a,b){return Date.parse(a.date) - Date.parse(b.date)});
    }
