...
import Triathlon from "./code/model/triathlon.js";

//Creates new triathlon and loads data from localstorage if available
...
//Base function to display the base content of the page
function DisplayContent() {
    ...
    //Display login page if no data available else display main content
  ...
  //Displays contents of the triathlon object
  ...
  //Contains the code for finding an exercise
...
//Displays the Stats about the exercises  
                    ...
                    <tbody>
                        ...
                        return (
                            <tr key={`${goal.id} goal`}>
                                ...
                                <td>{ goal.date}</td>
                                {(() => {
                                                if (goal.goalComplete == false){
                                                    return (
                                                        <td id='goalNotAchieved'>No</td>
                                                    )
                                                }
                                                return <td id='goalAchieved'>Yes, Good Work!</td>
                                                })()}
